  ...
  return (
    <div className="container pt-8">
        <div className="grid xl:grid-cols-3 xl:grid-rows-2 gap-8">
            ...
            <div className="absolute max-w-[470px] sm:ml-16 top-[50%] -translate-y-[50%] sm:space-y-4">
...
<div className="relative">
    <img src='/hero__2.webp' className='w-full h-full object-cover rounded-lg' alt='hero image' />
<div className='absolute max-w-[470px] sm:ml-16 top-[50%] -translate-y-[50%] sm:space-y-2'>
    <h2 className='text-2xl sm:text-3xl font-bold'>Best Yummy Pizza</h2>
    <p className='text-gray-500 text-2xl pt-4'>Starting At</p>
...
<div className="relative">
    <img src='/hero__3.webp' className='w-full h-full object-cover rounded-lg' alt='hero image' />
<div className='absolute max-w-[470px] sm:ml-16 top-[50%] -translate-y-[50%] sm:space-y-2'>
